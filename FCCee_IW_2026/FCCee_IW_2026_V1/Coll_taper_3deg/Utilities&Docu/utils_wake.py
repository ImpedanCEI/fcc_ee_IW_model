...
def plot_wake(
    ...
    wake_name : str
        Name used for the legend and output filename.

    wake_component : str
        Wake component to plot.
    ...
    label : str, optional
        Label for the plotted wake.

    convention : {"pyheadtail", "xwakes"}
        Wake convention.

    xlim : tuple, optional
        x-axis limits, e.g. (0, 100).

    ylim : tuple, optional
        y-axis limits, e.g. (-1e5, 1e5).
    """
